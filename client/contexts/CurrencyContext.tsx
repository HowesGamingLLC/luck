...
interface CurrencyContextType {
  ...
  updateBalance: (currency: CurrencyType, amount: number, description: string, type?: 'win' | 'wager' | 'bonus') => void;
    ...
    if (savedUser) {
      try {
        ...
        if (parsedUser.lastDailySpinClaim) {
          parsedUser.lastDailySpinClaim = new Date(parsedUser.lastDailySpinClaim);
        }
        setUser(parsedUser);
      } catch (error) {
