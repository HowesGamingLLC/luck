...
const achievements = [
  ...
  },
  {
    id: 2,
    name: "Lucky Seven",
    description: "Won 7 times in a row",
    icon: Target,
    earned: true,
    rarity: "rare",
  },
  {
    id: 3,
    name: "Big Spender",
    description: "Accumulated $1000+ in winnings",
    icon: Coins,
    earned: true,
    rarity: "epic",
  },
  {
    id: 4,
    name: "Streak Master",
    description: "Maintain a 20+ day winning streak",
    icon: Zap,
    earned: true,
    rarity: "legendary",
  },
  ...
  },
  {
    id: 6,
    name: "High Roller",
    description: "Win $500+ in a single spin",
    icon: Star,
    earned: false,
    rarity: "legendary",
  },
  ...
  },
  {
    id: 8,
    name: "Fortune Finder",
    description: "Win the maximum prize",
    icon: Gift,
    earned: false,
    rarity: "mythic",
  },
              ...
              <Card className="glass">
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-success">
                    ${mockUser.totalWon.toLocaleString()}
                  </div>
                  <p className="text-xs text-muted-foreground">
                    Lifetime winnings
                  </p>
          ...
          <TabsContent value="activity" className="space-y-6">
            <Card className="glass">
              <CardHeader>
                ...
                <CardDescription>
                  Your latest gaming activity and achievements
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
              ...
              <CardContent className="space-y-6">
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Advanced settings and preferences will be available in the
                    full Settings page.
                  </p>
