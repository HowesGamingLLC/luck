...
export default function Games() {
  ...
  const gameStats = [
    { label: "Your Balance", value: `$${userBalance.toLocaleString()}`, icon: Coins, color: "text-gold" },
      ...
      <div className="container">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Try your luck with our daily spin wheel! Win cash prizes, bonuses, and exclusive rewards.
          </p>
        </div>
              ...
              <CardContent className="space-y-3">
                {recentActivity.map((activity, index) => (
                  <div key={index} className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-2">
                      <Badge 
                        variant={activity.type === "win" ? "default" : "secondary"}
            ...
            <Card className="glass p-8">
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground">
                  You have <span className="text-gold font-semibold">3 spins</span> remaining today
                </p>
              </div>
