...
export interface Achievement {
  ...
  name: string;
  description: string;
  category: 'general' | 'slots' | 'poker' | 'bingo' | 'sports' | 'social' | 'progression';
...
export class AchievementEngine extends EventEmitter {
  ...
  private initializeAchievements(): void {
    const achievements: Achievement[] = [
      // General Achievements
      {
        ...
        rarity: 'common',
        requirements: [
          { type: 'stat', metric: 'total_wins', operator: 'greater_equal', value: 1 }
        ],
        rewards: [
...

      {
        ...
        rarity: 'rare',
        requirements: [
          { type: 'stat', metric: 'total_wagered_gc', operator: 'greater_equal', value: 1000 }
        ],
        rewards: [
        ...
        tiers: [
          {
            tier: 1,
            name: 'Spender',
            requirements: [{ type: 'stat', metric: 'total_wagered_gc', operator: 'greater_equal', value: 1000 }],
            rewards: [{ type: 'currency', amount: 500, currency: 'GC' }]
          },
          {
            tier: 2,
            name: 'Big Spender',
            requirements: [{ type: 'stat', metric: 'total_wagered_gc', operator: 'greater_equal', value: 10000 }],
            rewards: [{ type: 'currency', amount: 2500, currency: 'GC' }]
          },
          {
            tier: 3,
            name: 'High Roller',
            requirements: [{ type: 'stat', metric: 'total_wagered_gc', operator: 'greater_equal', value: 100000 }],
            rewards: [{ type: 'currency', amount: 25000, currency: 'GC' }, { type: 'title', unlockId: 'high_roller' }]
          }
        ]
      },
      ...
      // Slots Achievements
      {
        ...
        rarity: 'epic',
        requirements: [
          { type: 'stat', metric: 'slots_total_spins', operator: 'greater_equal', value: 1000 }
        ],
        rewards: [
        ...
        tiers: [
          {
            tier: 1,
            name: 'Spin Novice',
            requirements: [{ type: 'stat', metric: 'slots_total_spins', operator: 'greater_equal', value: 100 }],
            rewards: [{ type: 'currency', amount: 500, currency: 'GC' }]
          },
          {
            tier: 2,
            name: 'Spin Expert',
            requirements: [{ type: 'stat', metric: 'slots_total_spins', operator: 'greater_equal', value: 1000 }],
            rewards: [{ type: 'currency', amount: 2500, currency: 'GC' }]
          },
          {
            tier: 3,
            name: 'Slot Master',
            requirements: [{ type: 'stat', metric: 'slots_total_spins', operator: 'greater_equal', value: 10000 }],
            rewards: [{ type: 'currency', amount: 25000, currency: 'GC' }, { type: 'title', unlockId: 'slot_master' }]
          }
        ]
      },

      {
        ...
        rarity: 'legendary',
        requirements: [
          { type: 'stat', metric: 'slots_jackpots_won', operator: 'greater_equal', value: 1 }
        ],
        rewards: [
      ...
      // Poker Achievements
      {
        ...
        rarity: 'rare',
        requirements: [
          { type: 'stat', metric: 'poker_hands_won', operator: 'greater_equal', value: 100 }
        ],
        rewards: [
...

      {
        ...
        rarity: 'mythic',
        requirements: [
          { type: 'action', metric: 'royal_flush_achieved', operator: 'equals', value: 1 }
        ],
        rewards: [
      ...
      // Bingo Achievements
      {
        ...
        rarity: 'epic',
        requirements: [
          { type: 'stat', metric: 'bingo_games_won', operator: 'greater_equal', value: 50 }
        ],
        rewards: [
          { type: 'currency', amount: 5000, currency: 'GC' },
      ...
      // Sports Betting Achievements
      {
        ...
        rarity: 'legendary',
        requirements: [
          { type: 'action', metric: 'parlay_won', operator: 'greater_equal', value: 5 }
        ],
        rewards: [
      ...
      // Social Achievements
      {
        ...
        rarity: 'rare',
        requirements: [
          { type: 'stat', metric: 'referrals', operator: 'greater_equal', value: 10 }
        ],
        rewards: [
          { type: 'currency', amount: 5000, currency: 'GC' },
      ...
      // Streak Achievements
      {
        ...
        rarity: 'epic',
        requirements: [
          { type: 'stat', metric: 'current_streak', operator: 'greater_equal', value: 10 }
        ],
        rewards: [
          { type: 'currency', amount: 2000, currency: 'GC' },
      ...
      // Time-based Achievements
      {
        ...
        rarity: 'common',
        requirements: [
          { type: 'condition', metric: 'play_time_hour', operator: 'less_than', value: 8 }
        ],
        rewards: [
          { type: 'currency', amount: 250, currency: 'GC' }
        ],
        icon: 'sunrise'
      },

      {
        ...
        rarity: 'common',
        requirements: [
          { type: 'condition', metric: 'play_time_hour', operator: 'greater_equal', value: 0 }
        ],
        rewards: [
          { type: 'currency', amount: 250, currency: 'GC' }
        ],
  ...
  private initializeBadgesAndTitles(): void {
    // Badges
    const badges: Badge[] = [
      { id: 'big_spender', name: 'Big Spender', description: 'Wagered significant amounts', rarity: 'rare', icon: 'dollar-sign', color: 'gold' },
      { id: 'slot_master', name: 'Slot Master', description: 'Expert slot player', rarity: 'epic', icon: 'zap', color: 'purple' },
      { id: 'jackpot_hunter', name: 'Jackpot Hunter', description: 'Won a progressive jackpot', rarity: 'legendary', icon: 'crown', color: 'gold' },
      { id: 'poker_shark', name: 'Poker Shark', description: 'Skilled poker player', rarity: 'rare', icon: 'spade', color: 'blue' },
      { id: 'royal_flush', name: 'Royal Flush', description: 'Achieved a royal flush', rarity: 'mythic', icon: 'star', color: 'rainbow' },
      { id: 'bingo_master', name: 'Bingo Master', description: 'Expert bingo player', rarity: 'epic', icon: 'target', color: 'green' },
      { id: 'parlay_master', name: 'Parlay Master', description: 'Won a 5+ leg parlay', rarity: 'legendary', icon: 'trending-up', color: 'red' }
    ];

    // Titles
    const titles: Title[] = [
      { id: 'high_roller', name: 'High Roller', description: 'Elite player status', rarity: 'epic', color: 'gold' },
      { id: 'slot_master', name: 'Slot Master', description: 'Master of the reels', rarity: 'epic', color: 'purple' },
      { id: 'jackpot_king', name: 'Jackpot King', description: 'Ruler of jackpots', rarity: 'legendary', color: 'gold' },
      { id: 'poker_legend', name: 'Poker Legend', description: 'Legendary poker skills', rarity: 'mythic', color: 'platinum' }
    ];
  ...
  private getStatValue(stats: PlayerStats, category: string): number {
    switch (category) {
      case 'total_winnings_gc': return stats.totalWinnings.gc;
      case 'total_winnings_sc': return stats.totalWinnings.sc;
      case 'slots_total_spins': return stats.slots.totalSpins;
      case 'poker_hands_played': return stats.poker.handsPlayed;
      case 'bingo_games_won': return stats.bingo.gamesPlayed;
  ...
  public updatePlayerStats(playerId: string, updates: Partial<PlayerStats>): void {
  ...
  public recordGameAction(
    ...
    switch (action) {
      ...
      case 'royal_flush':
        ...
        this.checkAchievementProgress(playerId, 'royal_flush', { royal_flush_achieved: 1 });
        break;
      ...
      case 'parlay_won':
        ...
        if (data.legs >= 5) {
          this.checkAchievementProgress(playerId, 'parlay_master', { parlay_won: data.legs });
        }
        break;
    }
  ...
  private checkLevelProgression(playerId: string): void {
    ...
    const currentLevel = this.progressionLevels.find(l => l.level === stats.level);
    if (!currentLevel) return;

    const nextLevel = this.progressionLevels.find(l => l.level === stats.level + 1);
    if (!nextLevel) return;
    ...
    if (stats.xp >= nextLevel.xpRequired) {
      ...
      this.emit('levelUp', { playerId, newLevel: stats.level, rewards: nextLevel.rewards });
  ...
  private checkPlayerAchievements(playerId: string): void {
    ...
    for (const [achievementId, achievement] of this.achievements) {
      if (achievement.isSecret && !this.hasMetRequirements(stats, achievement.requirements)) {
  ...
  private checkAchievementProgress(playerId: string, achievementId: string, data: any): void {
  ...
  private hasMetRequirements(data: any, requirements: AchievementRequirement[]): boolean {
  ...
  private unlockAchievement(playerId: string, achievementId: string, tier?: number): void {
    const achievement = this.achievements.get(achievementId);
    if (!achievement) return;
  ...
  public getLeaderboard(category: string, limit: number = 100): LeaderboardEntry[] {
