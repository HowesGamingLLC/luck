    ...
    return [
      {
        ...
        description:
          "Classic 3-reel casino slot machine with traditional fruit symbols.",
        features: [
          "Classic Reels",
          "Fruit Symbols",
          "HTML5",
      ...
      },
      {
        ...
        description:
          "Spin the wheel of fortune for exciting prizes and jackpots.",
        features: [
          "Wheel of Fortune",
          "Jackpot",
          "Simple Gameplay",
      ...
      },
      {
        ...
        description:
          "Traditional fruit machine with classic symbols and bonus features.",
        features: [
          "Traditional Fruits",
          "Bonus Features",
          "Classic Design",
      ...
      },
      {
        ...
        description:
          "Sparkling diamond slot with luxury gems and exciting bonus rounds.",
        features: [
          "Diamond Wilds",
          "Free Spins",
          "Gem Symbols",
      ...
      },
      {
        ...
        description:
          "Experience the excitement of Las Vegas with neon lights and big wins.",
