...
export class PragmaticPlayProvider extends BaseSlotProvider {
  ...
  private hasFeature(game: any, feature: string): boolean {
    return (
      ...
      game.gameName?.toLowerCase().includes(feature) ||
      false
    );
  }
  ...
  private extractFeatures(game: any): string[] {
    ...
    if (description.includes("wild") || gameName.includes("wild"))
      features.push("Wild Symbols");
    if (description.includes("scatter") || gameName.includes("scatter"))
      features.push("Scatter Pays");
    if (description.includes("freespins") || description.includes("free spins"))
      features.push("Free Spins");
    if (description.includes("bonus") || gameName.includes("bonus"))
      features.push("Bonus Round");
    if (description.includes("jackpot") || gameName.includes("jackpot"))
      features.push("Jackpot");
